...
router.post('/company/:companyId/templates', authorize(['Super Admin', 'HR Manager', 'HR Staff']), (req, res) => allowanceController.createCompanyAllowance(req, res));
...
router.post('/templates/:id/apply', authorize(['Super Admin', 'HR Manager', 'HR Staff']), (req, res) => allowanceController.applyCompanyAllowanceToEmployees(req, res));
...
router.post('/bulk', authorize(['Super Admin', 'HR Manager', 'HR Staff']), (req, res) => allowanceController.bulkCreate(req, res));

// DELETE /api/v1/allowances/bulk - Bulk delete allowances
router.delete('/bulk', authorize(['Super Admin', 'HR Manager', 'HR Staff']), (req, res) => allowanceController.bulkDelete(req, res));

// PATCH /api/v1/allowances/bulk/status - Bulk update status
router.patch('/bulk/status', authorize(['Super Admin', 'HR Manager', 'HR Staff']), (req, res) => allowanceController.bulkUpdateStatus(req, res));
...
router.post('/', authorize(['Super Admin', 'HR Manager', 'HR Staff']), (req, res) => allowanceController.create(req, res));
...
router.put('/:id', authorize(['Super Admin', 'HR Manager', 'HR Staff']), (req, res) => allowanceController.update(req, res));

// DELETE /api/v1/allowances/:id - Soft delete allowance
router.delete('/:id', authorize(['Super Admin', 'HR Manager', 'HR Staff']), (req, res) => allowanceController.delete(req, res));
